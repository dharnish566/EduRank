...
const CollegeFinderPage = () => {
  return (
    <div>
      <p>College Finder Page is Loading...</p>
    </div>
  )
}
...
//     const collegeScore = college.naacGrade ? gradeToScore[college.naacGrade] ?? 0 : 0;
...
//       const collegeOrder = college.naacGrade ? NAAC_GRADE_ORDER[college.naacGrade] ?? 0 : 0;
...
//   if (college.nirfRank !== null && college.nirfRank !== undefined && college.nirfRank <= nirfLimit) {
//     nirfScore = 10;
//   }
...
//     const hasMatch = college.courses.some((c) => (typeof c === 'string' ? c : c.course_name).toLowerCase().includes(keyword));
