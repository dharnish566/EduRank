export interface College {
  ...
  placementTrend: { year: number; pct: number; avgLPA: number }[];
  salaryBands: { label: string; count: number }[];
  topRecruiters: { name: string; role: string; avgPackage: number }[];
...
export const COLLEGES: College[] = [
  {
    ...
    courses: ["B.Tech", "M.Tech", "MBA", "Ph.D", "M.Sc"],
    established: 1959,
    trend: "stable",
    trendChange: 0,
    about:
      "Indian Institute of Technology Madras (IIT Madras) is a public technical university located in Chennai, Tamil Nadu. Established in 1959 with assistance from the former Government of West Germany, it is one of the Institutes of National Importance and is consistently ranked as the top engineering institution in India by the National Institutional Ranking Framework.\n\nThe institute offers a unique residential campus experience spanning over 600 acres in the heart of Chennai, featuring a protected forest area. IIT Madras has earned an international reputation for its rigorous academic programmes, world-class research output, and a thriving entrepreneurial ecosystem through its research park — one of the first of its kind in India.\n\nWith over 550 faculty members, 9,500 students, and 550+ active research projects, IIT Madras continues to push boundaries in science, engineering, and technology. The institute's alumni network spans the globe, with graduates leading Fortune 500 companies, research laboratories, and government bodies across every continent.",
    feeRange: { min: 75, max: 220 },
    placementTrend: [
      { year: 2020, pct: 92.4, avgLPA: 21.8 },
      { year: 2021, pct: 94.1, avgLPA: 23.5 },
      { year: 2022, pct: 95.8, avgLPA: 25.2 },
      { year: 2023, pct: 96.7, avgLPA: 27.1 },
      { year: 2024, pct: 97.2, avgLPA: 28.4 },
    ],
    salaryBands: [
      { label: "5–10 LPA", count: 12 },
      { label: "10–20 LPA", count: 28 },
      { label: "20–40 LPA", count: 185 },
      { label: "40–60 LPA", count: 142 },
      { label: "60–100 LPA", count: 87 },
      { label: "100+ LPA", count: 34 },
    ],
    topRecruiters: [
      { name: "Google", role: "Software Engineer", avgPackage: 45.0 },
      { name: "Microsoft", role: "SDE / Research", avgPackage: 42.0 },
      { name: "Goldman Sachs", role: "Analyst / Quant", avgPackage: 38.0 },
      { name: "McKinsey", role: "Business Analyst", avgPackage: 35.0 },
      { name: "Amazon", role: "SDE / Data Engineer", avgPackage: 32.0 },
      { name: "Intel", role: "VLSI / Chip Design", avgPackage: 28.0 },
      { name: "Qualcomm", role: "Firmware Engineer", avgPackage: 26.0 },
      { name: "Flipkart", role: "SDE / Product", avgPackage: 24.0 },
    ],
    facilities: [
      {
        ...
        icon: "📚",
        description:
          "Over 4 lakh books, 10,000+ e-journals, and 24×7 digital access for all students.",
      },
      {
        name: "Research Park",
        icon: "🔬",
        description:
          "India's first campus-based technology research park hosting 200+ companies and startups.",
      },
      {
        name: "Sports Complex",
        icon: "🏊",
        description:
          "Olympic-grade swimming pool, tennis courts, cricket ground, football pitch, and indoor stadium.",
      },
      {
        name: "Healthcare Centre",
        icon: "🏥",
        description:
          "24×7 hospital with specialists, diagnostic lab, pharmacy, and mental health counselling.",
      },
      {
        name: "Hostel Accommodation",
        icon: "🏠",
        description:
          "19 hostels housing 9,500+ students with high-speed Wi-Fi, dining halls, and recreation rooms.",
      },
      {
        name: "Supercomputer Facility",
        icon: "💻",
        description:
          "Shakti processor-based HPC cluster with 800 TFLOPS peak computational power for research.",
      },
      {
        name: "Innovation Lab",
        icon: "⚗️",
        description:
          "Cutting-edge fabrication and prototyping labs with 3D printing, CNC, and electronics benches.",
      },
      {
        name: "Forest Campus",
        icon: "🌳",
        description:
          "600-acre protected forest campus with deer, peacocks, and biodiversity conservation areas.",
      },
    ],
    admissionInfo: {
      process: [
        "Appear for JEE Advanced — only JEE Main qualified students are eligible.",
        "Secure a competitive rank in JEE Advanced (top 2.5 lakh students).",
        "Participate in JoSAA (Joint Seat Allocation Authority) counselling online.",
        "Select preferred programme and campus during choice filling.",
        "Complete document verification and fee payment at reporting centre.",
        "Attend orientation and commence classes as per academic calendar.",
      ],
      eligibility: [
        "Passed Class 12 or equivalent with Physics, Chemistry, and Mathematics.",
        "Minimum 75% aggregate in Class 12 (65% for SC/ST candidates).",
        "Qualified JEE Main with valid score in the current academic year.",
        "Age limit: born on or after October 1, 1999 (general); 1994 for PwD.",
        "Maximum two attempts at JEE Advanced allowed.",
      ],
      keyDates: [
        { event: "JEE Advanced Registration", date: "Apr 28, 2024" },
        { event: "JEE Advanced Exam", date: "May 26, 2024" },
        { event: "Result Declaration", date: "Jun 9, 2024" },
        { event: "JoSAA Round 1 Allotment", date: "Jun 20, 2024" },
        { event: "Document Verification", date: "Jul 1–10, 2024" },
        { event: "Classes Commence", date: "Jul 22, 2024" },
      ],
    },
    coursesDetailed: [
      {
